...
Features
Location Selection: Dropdown menus for selecting any state and city in India (200+ cities covered)
Date Range Selection: Full year or custom date range from 2017 onwards
Satellite Data Sources:
Sentinel-2 (10m resolution)
Landsat 8/9 (30m resolution)
LULC Analysis: Using Google's Dynamic World dataset with 9 land cover classes
Vegetation Indices: NDVI, NDWI, NDBI, EVI, SAVI calculations
Interactive Map: Folium-based map with layer controls
Statistics: Land cover percentage and area (km²) breakdown
Time Series Analysis: Compare LULC changes between two different years
Custom AOI Drawing: Draw custom areas on map for specific region analysis
Export/Download: CSV statistics and GeoTIFF exports
