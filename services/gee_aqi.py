...
POLLUTANT_INFO = {
    ...
    "NO2": {
        ...
        "description": "Nitrogen dioxide at surface level from vehicles and industry",
        "who_limit": 25,
        "who_annual": 10,
        "comparable": True,
        "data_source": "CAMS Surface",
    ...
    "SO2": {
        ...
        "description": "Sulfur dioxide at surface level from power plants and industry",
        "who_limit": 40,
        "comparable": True,
        "data_source": "CAMS Surface",
    },
    "CO": {
        ...
        "max": 10,
        "palette": ["#00ff00", "#ffff00", "#ff9900", "#ff0000", "#990066"],
        "description": "Carbon monoxide at surface level from combustion",
        "who_limit": 4,
        "comparable": True,
        "data_source": "CAMS Surface",
    },
    "O3": {
        ...
        "max": 200,
        "palette": ["#00ff00", "#ffff00", "#ff9900", "#ff0000", "#990066"],
        "description": "Surface ozone (8-hour peak)",
        "who_limit": 100,
        "comparable": True,
        "data_source": "CAMS Surface",
    },
    "NO2_Column": {
        ...
        "max": 200,
        "palette": ["#00ff00", "#ffff00", "#ff9900", "#ff0000", "#990066", "#660033"],
        "description": "Total atmospheric column NO₂ from Sentinel-5P satellite",
        "comparable": False,
    ...
    "SO2_Column": {
        ...
        "max": 500,
        "palette": ["#00ff00", "#ffff00", "#ff9900", "#ff0000", "#990066"],
        "description": "Total atmospheric column SO₂ from Sentinel-5P satellite",
        "comparable": False,
        "data_source": "Sentinel-5P",
    },
    "CO_Column": {
        ...
        "max": 50,
        "palette": ["#00ff00", "#ffff00", "#ff9900", "#ff0000", "#990066"],
        "description": "Total atmospheric column CO from Sentinel-5P satellite",
        "comparable": False,
        "data_source": "Sentinel-5P",
    },
    "O3_Column": {
        ...
        "max": 200,
        "palette": ["#00ff00", "#ffff00", "#ff9900", "#ff0000", "#990066"],
        "description": "Total atmospheric column O₃ from Sentinel-5P satellite",
        "comparable": False,
        "data_source": "Sentinel-5P",
    },
    "UVAI": {
